%% Inverted Delta with - Interior U-shape Templete
...
i_Slot_Depth_Ratio  %Ratio of slot depth
...
% L1 U Magnet Web Thickness
    % L1 U Magnet Diameter
        % L1 U Magnet Outer Length
        % L1 U Magnet Inner Length
        % L2 U Magnet Web Thickness


i_Split_Ratio       %Ratio of stator bore
i_Slot_Depth_Ratio  %"Ratio_SlotDepth_ParallelTooth" );
...
[success,i_Slot_Depth_Ratio]=invoke(mcad,'GetVariable',"Ratio_SlotDepth_ParallelTooth" );
